...
export const DOCTOR_OVERVIEW = {
    ...
    detection: {
        ...
        timeSeries: {
            '24h': [
                {timestamp: '2025-11-13T00:00:00Z', bpm: 72},
                {timestamp: '2025-11-13T02:00:00Z', bpm: 70},
                {timestamp: '2025-11-13T04:00:00Z', bpm: 68},
                {timestamp: '2025-11-13T06:00:00Z', bpm: 74},
                {timestamp: '2025-11-13T08:00:00Z', bpm: 77},
                {timestamp: '2025-11-13T10:00:00Z', bpm: 75},
                {timestamp: '2025-11-13T12:00:00Z', bpm: 73},
                {timestamp: '2025-11-13T14:00:00Z', bpm: 71},
                {timestamp: '2025-11-13T16:00:00Z', bpm: 69},
                {timestamp: '2025-11-13T18:00:00Z', bpm: 70},
                {timestamp: '2025-11-13T20:00:00Z', bpm: 72},
                {timestamp: '2025-11-13T22:00:00Z', bpm: 74},
                {timestamp: '2025-11-14T00:00:00Z', bpm: 71}
            ],
            '7d': [
                {day: 'Mon', bpm: 72},
                {day: 'Tue', bpm: 70},
        ...
        signals: [
            {id: 'avg', label: 'Average HRV', value: '72 ms', note: 'Stable'},
            {id: 'max', label: 'Max HRV', value: '77 ms', note: 'Healthy'},
            {id: 'min', label: 'Min HRV', value: '68 ms', note: 'Mild stress'}
        ]
    },
