  ...
  return (
    <section className="doctor-dashboard">
          ...
          <div className="doctor-dashboard__pie-wrapper">
            ...
            <ul className="doctor-dashboard__legend">
              {stressBreakdown.map((segment) => (
                <li key={segment.id}>
                  <span className="doctor-dashboard__legend-dot" style={{ backgroundColor: segment.color }} />
      ...
      <section className="doctor-dashboard__main">
        <article className="doctor-dashboard__card doctor-dashboard__card--chart">
          <div className="doctor-dashboard__card-header">
            <h3>{detection.label}</h3>
            <span className="doctor-dashboard__chip">{detection.metric}</span>
          </div>
          <DoctorDetectionChart series={detection.series} />
        </article>
